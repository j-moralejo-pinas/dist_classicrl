...
class TestOptimalQLearningBase:
    ...
    def test_initialization_with_numpy_integers(self) -> None:
    ...
    def test_get_state_q_values(self) -> None:
    ...
    def test_get_states_q_values(self) -> None:
    ...
    def test_choose_action_deterministic(self) -> None:
    ...
    def test_choose_action_tie_breaking(self) -> None:
    ...
    def test_choose_action_exploration(self) -> None:
    ...
    def test_choose_action_no_exploration(self) -> None:
    ...
    def test_choose_masked_action(self) -> None:
    ...
    def test_choose_masked_action_exploration(self) -> None:
    ...
    def test_choose_masked_action_invalid_mask(self) -> None:
    ...
    def test_choose_actions_iter(self) -> None:
    ...
    def test_choose_actions_iter_with_masks(self) -> None:
    ...
    def test_choose_action_vec(self) -> None:
    ...
    def test_choose_masked_action_vec(self) -> None:
    ...
    def test_choose_masked_action_vec_invalid_mask(self) -> None:
    ...
    def test_choose_actions_vec_iter(self) -> None:
    ...
    def test_choose_actions_vec(self) -> None:
    ...
    def test_choose_masked_actions_vec(self) -> None:
    ...
    def test_choose_masked_actions_vec_invalid_shape(self) -> None:
    ...
    def test_choose_actions_dispatch(self) -> None:
    ...
    def test_single_learn_not_terminated(self) -> None:
    ...
    def test_single_learn_terminated(self) -> None:
    ...
    def test_single_learn_with_mask(self) -> None:
    ...
    def test_learn_dispatch(self) -> None:
    ...
    def test_learn_with_large_batch(self) -> None:
    ...
    def test_choose_action_randomness(self, mock_randint, mock_uniform) -> None:
    ...
    @patch("random.choice")
    def test_choose_action_tie_breaking_randomness(self, mock_choice) -> None:
    ...
    def test_q_table_operations_consistency(self) -> None:
...
class TestOptimalQLearningParametrized:
    ...
    def test_exploration_rates(self, exploration_rate: float) -> None:
